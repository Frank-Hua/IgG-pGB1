...
%Choose the size of the frames and whether to transpose them.
situ = input('movie option: [(0)-256, (1)-256 xy flipped, (2)-512, (3)-512 xy flipped] ');
if isempty(situ)
    situ=0;
end
...
%.smm file (read into frame) provides intensity information of selected binding sites.
