...
fxy_pos is a floating number recording xy coordinate in the unit of diffration-limited pixel number.
xy_pos is an integer number recording xy coordinate in the unit of diffration-limited pixel number.
%}
